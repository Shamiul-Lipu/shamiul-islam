...
const Socials = () => {
    return (
        <>
            <ul className="font-bold text-primary fixed bottom-10 bg-[#38bdf8] p-1 ml-2 mx-auto z-30 gap-1 flex flex-col rounded-lg opacity-40 hover:opacity-100 border-[3px] border-cyan-200 hover:border-primary border-opacity-100">
                <li className="hover:bg-cyan-200 p-2 rounded-lg transition-all cursor-pointer " >
